...
stackfolder = 'MP01_22C/'; % 'MP09_22C/'; % 'MGa2x/'; % 'MP05_22C/'; % 'MP10_22C/'; %'MGa1x/'; % 'MGa2x/'; % 'MP10_22C_sna_y_c/'; %
fname = 'MP01_22C_hb_y'; Es = 13; % 'MP09_22C_hb_y_e'; Es = 10; % 'MP09_22C_hb_y_d'; Es=11; % 'MGa2x_LacZ_sna_b'; Es = 10; % 'MP05_22C_sna_y_c'; Es =7;  % 'MP10_22C_sna_y_d';   % 'MGa_LacZ'; %'MGa2x_LacZ_sna'; %'MP10_22C_sna_y_c'; old_lab = 1;  % 'MP05_22C_sna_y'; old_lab = 1; % 
