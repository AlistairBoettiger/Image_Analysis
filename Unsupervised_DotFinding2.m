...
disp('loading data...');
    ...
    for mRNAchn = 1:mRNA_channels % mRNAchn =2
        ...
        if mRNAchn == 1
            min_int  = min_int1;%  0.06; %  0.07; %
            min_peak = min_peak1; % 6000; %4500 7000 %
        elseif mRNAchn ==2
            min_int = min_int2; % .025;
            min_peak = min_peak2; %  3000;
        end
