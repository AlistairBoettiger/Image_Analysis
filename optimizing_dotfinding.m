...
xp1 = 1000; xp2 = xp1+200;
yp1 = 1700; yp2 = yp1+200;
...
ck_dots = tic;
        NewDotC1 = CheckDotUpDown(DotData1,DotMasks1,im_folder,1,plotZdata,getpreciseZ,consec_layers,ovlap,xp1,xp2,yp1,yp2);
        NewDotC2 = CheckDotUpDown(DotData2,DotMasks2,im_folder,2,plotZdata,getpreciseZ,consec_layers,ovlap,xp1,xp2,yp1,yp2);
 toc(ck_dots) 
        %% Project all layers
        ...
        if show_projected == 1
            ...
            %colormap hot;
            hold on;
            plot(  NewDotC1(:,1),NewDotC1(:,2),'mo','MarkerSize',14 );
